...
OUTPUT_DIR = BASE_DIR / "outputs_universal_v5_baker_4s"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
BRAIN_DIR = Path("/Users/robzomb/.gemini/antigravity/brain/a6b18108-3903-4957-ade7-687e85eb20df/universal_v5_gallery")
BRAIN_DIR.mkdir(parents=True, exist_ok=True)
ASSETS_DIR = BASE_DIR / "assets/universal_v5"
...
def main():
    print("=" * 100)
    print("💎 RUNNING UNIVERSAL FAST MASTER V5 (C / METAL 4 ENHANCED - 4.0s BAKER SCENE)")
    print("   Enhancements Active: Causal Cosine S-Curve, Latent Anti-Shimmering, Aspect-Scaled RoPE, SNR Guidance")
    ...
    raw_mp4 = OUTPUT_DIR / "universal_v5_baker_4s_raw.mp4"
    master_mp4 = OUTPUT_DIR / "universal_v5_baker_4s_master.mp4"
    gif_path = OUTPUT_DIR / "universal_v5_baker_4s_animated.gif"
    thumb_path = OUTPUT_DIR / "universal_v5_baker_4s_thumb.jpg"
    ...
    result_data = {
        "model": "Universal Fast Master v5 (C/Metal Enhanced)",
        "prompt": PROMPT,
        "seed": SEED,
        "width": WIDTH,
        "height": HEIGHT,
    ...
    with open(OUTPUT_DIR / "universal_v5_baker_4s_results.json", "w") as f:
        json.dump(result_data, f, indent=2)

    print("=" * 100)
    print("✅ GENERAZIONE V5 E MASTERING COMPLETATI CON SUCCESSO!")
